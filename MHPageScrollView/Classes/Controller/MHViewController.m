...
- (void)viewDidLoad {
    ...
    self.pageScrView1 = [[MHPageScrView alloc] initWithFrame:CGRectMake(0, 50, KScreenW, h) imageUrls:@[@"http://a.hiphotos.baidu.com/image/pic/item/1f178a82b9014a90aeefd5dcaf773912b21beefa.jpg", @"http://pic30.nipic.com/20130624/7447430_170252095000_2.jpg", @"http://img.taopic.com/uploads/allimg/110819/1717-110Q9215S612.jpg", @"http://g.hiphotos.baidu.com/image/h%3D200/sign=96af9bbb239759ee555067cb82fa434e/902397dda144ad34c7d77831d5a20cf431ad8518.jpg"] placeImage:nil];
...
- (void)toolbar:(MHToolbar *)toolbar didClickButton:(UIButton *)button
{
    ...
    if (button.tag == 1) {
        ...
        // 2.1.添加scrollView(网络下载图片)
        [_pageScrView2 removeFromSuperview];
        [self.view addSubview:_pageScrView1];
        
        // 2.2.自定义分页指示器（如果不自定义，则使用默认的）
        CGFloat w = 50;
        [self.pageScrView1 setupPageControlFrame:CGRectMake(KScreenW - w - 15, kScrollViewH - 10*1.4, w, 10) currentPageIndicatorTintColor:[UIColor redColor] pageIndicatorTintColor:[UIColor groupTableViewBackgroundColor]];
